...
const DisplaySettings = () => {
  ...
  return (
    <div className="p-6 rounded-2xl bg-white dark:bg-[#242526] shadow-2xl w-full max-w-md mx-auto">
      ...
      {/* Dark Mode */}
      <div className="mb-6 p-4 rounded-xl border bg-slate-50 dark:bg-neutral-800 flex items-center gap-4">
        <Moon className="w-10 h-10 text-blue-400 dark:text-blue-300" />
        <div className="flex-1">
          ...
          <div className="flex gap-4">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="radio" name="darkMode" value="light" checked={theme === 'light'} onChange={handleDarkModeChange} className="accent-blue-500" />
              {t('off')}
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="radio" name="darkMode" value="dark" checked={theme === 'dark'} onChange={handleDarkModeChange} className="accent-blue-500" />
              {t('on')}
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="radio" name="darkMode" value="auto" checked={theme === 'auto'} onChange={handleDarkModeChange} className="accent-blue-500" />
              {t('auto')}
            </label>
          </div>
        </div>
