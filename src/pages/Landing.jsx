                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex gap-8 mt-5">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[#004AAD] text-base font-medium">Question bank</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <img src={blendIcon} alt="Mix exam" className="w-6 h-6" />
                            <span className="text-[#004AAD] text-base font-medium">Mix exam</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <img src={scanTextIcon} alt="Mark the multiple-choice sheet" className="w-6 h-6" />
                            <span className="text-[#004AAD] text-base font-medium">Mark the multiple-choice sheet</span>
                        </div>
                    </div>
                </div>
                {/* Right: Action Card */}
